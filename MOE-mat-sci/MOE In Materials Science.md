...
| **Unique Feature 4** | Attempts to **concentrate Expert probabilities** in a handful of Experts.$\lambda$ is used as a hyperparameter._The term below is **<u>added to loss:</u>**_<br>$(1,0,0,0,0) \rightarrow P = 0$<br>$(0.9,0,0,0,1,0) \rightarrow P = (0.9^2 + 0.1^2 - 1)^2 = (0.82 - 1)^2$ |
